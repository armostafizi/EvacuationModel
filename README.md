...
![Sample Evaucation Times\label{evac_times}](figs/ev_times.png)
![Evaucation Mortality Rate and Percentage of Evacuated\label{mortality_rate}](figs/mortality_rate.png)
